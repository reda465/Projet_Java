...
public class MockCallServerVideo {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("✅ MockCallServerVideo démarré sur port " + PORT);
            ...
            try {
                ...
                while ((line = in.readLine()) != null) {
                    ...
                    switch (cmd) {
                        ...
                        // CALL_REQUEST|dest|VIDEO ou AUDIO
                        case "CALL_REQUEST":
                            String dest = parts[1];
                            String type = parts[2];
                            ...
                            receiver.out.println("CALL_REQUEST|"
                                    + telephone + "|User_" + telephone + "|"
                                    + type + "|1|" + ipAppelant);

                            System.out.println("📞 CALL_REQUEST (" + type + ") envoyé à " + dest);
                            break;
